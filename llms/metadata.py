...
#
# id: key_definitions
#   msdmd: Module Self-Declared Metadata in Markdown — schema-2 native-first collection of existing code, documentation, manifest, schema, tooling and evidence metadata; tested static readers consume supported conventions and MSDMD blocks supply otherwise unexpressed information.
