// ratios: loc_comments=138:0 imports_exports=1:0 calls_definitions=1:0
  ...
  declarations: [
    {
      ...
      fields: {
        ...
        status: "canonical",
        summary: "Module Self-Declared Metadata in Markdown block syntax, parser contract, and visible gap doctrine",
      },
    },
    {
      ...
      fields: {
        ...
        summary: "Generates <reponame>_msdmd.ts collection points from module-local blocks",
      },
    },
    {
      ...
      fields: {
        ...
        summary: "Shared TypeScript shape for collection points and visualizers",
      },
    },
    {
  ...
  gaps: [
    {
      ...
      reason: "Seeded manually from known canonical surfaces; regenerate with python -m msdmd.collect after local checkout verification.",
    },
    {
      file: "ORG_DISTRIBUTION.md",
