...
This reference records the evidence boundary behind `information-design/SKILL.md`. It is deliberately narrower than popular "color psychology": the operational doctrine relies most strongly on perception, visual search, multimedia signaling, accessibility, and replicated/meta-analytic findings.
