...
| [`skill-usage/`](skill-usage/SKILL.md) | Evidence-bearing local usage maturity. Counts material invocations, preserves unknown outcomes as `hmmm`, and separates nominal exposure from effective maturity across experimental, field-test, operational, reliable, and daily-use designations. Independent of msdmd. |
...
`skill-usage`, and `ssh-automation`
